class FetchData {
  ...
  getPost = () => this.getResours('db/dataBase.json');
}
...
class Twitter {
  constructor({
    ...
    this.elements.showLikedPostElem.addEventListener('click', this.showLikedPosts)
  ...
  renderPosts(posts) {
    ...
    sortPost.forEach(
      ({ id, userName, nickname, text, img, likes, getDate, liked }) => {
